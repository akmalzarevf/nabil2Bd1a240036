...
<body class="bg-gray-100 min-h-screen">
    ...
    <header class="bg-blue-900 text-white text-center py-6 shadow">
        <h1 class="text-3xl font-bold">🖼️ Edit Gambar Gallery</h1>
    </header>
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                ...
                <li><a href="data_gallery.php" class="block font-bold text-blue-800">🖼️ Kelola Gallery</a></li>
                <li><a href="about.php" class="block hover:text-blue-600">👤 About</a></li>
                <li><a href="../auth/logout.php" onclick="return confirm('Yakin ingin keluar?');" class="block text-red-600 hover:underline font-medium">🚪 Logout</a></li>
            </ul>
        </aside>

        <!-- Main Content -->
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <h2 class="text-xl font-semibold text-blue-800 mb-6">✏️ Form Edit Gambar</h2>
            ...
            <form action="proses_edit_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <img src="../images/<?php echo htmlspecialchars($data['foto']); ?>" class="h-40 rounded shadow mb-3" alt="Foto Lama">
                </div>
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <a href="data_gallery.php" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400 transition">
                        Batal
                    </a>
                </div>
            </form>
