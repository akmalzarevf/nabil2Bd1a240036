...
<body class="bg-gray-100 min-h-screen font-sans">
    ...
    <header class="bg-blue-900 text-white text-center py-6 shadow">
        <h1 class="text-3xl font-bold">🖼️ Tambah Gambar ke Gallery</h1>
    </header>
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-6">
            ...
            <ul class="space-y-3 text-gray-700">
                ...
                <li><a href="data_gallery.php" class="block font-semibold text-blue-900">🖼️ Kelola Gallery</a></li>
        ...
        <!-- Main Content -->
        <main class="w-3/4 bg-white rounded shadow p-8 ml-6">
            <h2 class="text-xl font-semibold text-blue-800 mb-6">➕ Formulir Tambah Gambar</h2>
            <form action="proses_add_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
                <div>
                    ...
                    <input type="text" id="judul" name="judul" required class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label for="foto" class="block text-sm font-medium text-gray-700 mb-1">Pilih Gambar</label>
                    <input type="file" id="foto" name="foto" accept="image/*" required class="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200">
                </div>
